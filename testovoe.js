    ...
    constructor(items) {
        ...
        items.forEach((item) => {
            ...
            if (typeof id !== 'number' && typeof id !== 'string') {
                throw new TypeError(`Item id must be a number or a string, got ${typeof id}`);
            }
            if (typeof parent !== 'number' &&
                typeof parent !== 'string' &&
                parent !== null) {
                throw new TypeError(`Item parent must be a number, a string or null, got ${typeof parent}`);
            }
